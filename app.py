...
# Global definition for the target model to prevent repeating string edits
# Note: You can change this to "gemini-1.5-flash-latest" if you strictly want 1.5
    ...
    if submit_btn:
        if idea.strip() != "" and target_audience.strip() != "":
            try:
                ...
                st.info("💡 Tip: If you still see a 404 error, try opening your terminal and upgrading your local environment dependencies using: `pip install --upgrade google-generativeai`")
